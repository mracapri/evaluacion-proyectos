...
@Transactional
public class TestServicioResultado {
	...
	public void insertAndFindAll() {
		...
		/* Create Item rubrica */
		ItemRubrica itemRubrica = new ItemRubrica(1, "Deseño",
				"Caracteristicas e implementacion del diseño", escala1);
		itemRubricaDao.create(itemRubrica, rubrica);

		ItemRubrica itemRubrica2 = new ItemRubrica(2, "Deseño",
		...
		resultadoService.create(cal, evaluacion, proyecto);
		...
		Assert.assertTrue(resultadoService.laRubricaYaFueCapuradaParaElProyecto(proyecto, cal4));
		...
		Assert.assertTrue(read.calcularPorCategoria() == 9.5);
	}
}
